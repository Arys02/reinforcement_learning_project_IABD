...
impl Logger {
    pub fn new(model_name: &str) -> Self {
        ...
        let hyperparameters_file_name = format!("{}_{}_hyperparameters.csv", model_name, datetime_str);
    ...
    fn on_event(&mut self, event: &TrainingEvent) {
        ...
        match event {
            TrainingEvent::HyperparametersLogged { hyperparameters } => {
                ...
                let hyperparams_json = serde_json::to_string_pretty(hyperparameters)
                    .expect("Failed to serialize hyperparameters");

                std::fs::write(&self.hyperparameters_file_path, hyperparams_json)
            ...
            TrainingEvent::LoggingSummary {
                ...
                let record = LogRecord {
                    ...
                    mean_td_error: Some(*mean_td_error),
