...
use IABD4_reinforcement_learning::environement::grid_world::grid_world::GridWorld;
use IABD4_reinforcement_learning::environement::grid_world::grid_world::NUM_ACTIONS;
use IABD4_reinforcement_learning::environement::grid_world::grid_world::NUM_STATE_FEATURES;
...
use IABD4_reinforcement_learning::reinforcement_learning_functions::deep_reinforcement_learning_functions::episodic_semi_gradiant_sarsa::episodic_semi_gradient_sarsa;
...
fn main() {
    ...
    let model = episodic_semi_gradient_sarsa::<
        NUM_STATE_FEATURES,
        NUM_ACTIONS,
        _,
        MyAutodiffBackend,
        GameEnv,
    >(model, 50_000, 0.999f32, 3e-3, 1.0f32, 1e-5f32, device);
    ...
    model = deep_q_learning2::<NUM_STATE_FEATURES, NUM_ACTIONS, _, MyAutodiffBackend, GameEnv>(
        model.clone(),
        100_000,
        10000,
        10,
